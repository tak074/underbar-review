  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    if (!!iterator) {
      ...
      for (var i = 0; i < array.length; i++) {
        if (_.indexOf(iteratedVal, iterator(array[i])) === -1) {
          arr.push(array[i]);
          iteratedVal.push(iterator(array[i]));
        }
      }
    } else {
      for (var i = 0; i < array.length; i++) {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (!calledArgs[arg]) {
        ...
        calledArgs[arg] = func.apply(this, arguments);
      }
